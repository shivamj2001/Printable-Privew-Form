...
<div class="container-fluid">
    <div class="row">
      ...
      <div class="row">
          ...
          <div class="col">
            <div class="main-heading">Uttar Pradesh Power Corporation Limited
            </div>
            <p class="sub-heading">Electricity Service Commission,Power Corporation Ltd.S.L.D.C campus
                </p>
            <div class="address">MantriAwas Vibhuti Khand Phase-2,Gomti Nagar,Lucknow-226010
            </div>
             <p class="email">Email: uppcl@gmail.com , website: www.uppcl.org</p>
            </div>
            <div class="col-sm-12">
               <hr class="hrcls">
            </div>
     ...
     <div class="col-6">
           ...
           <div class="row">
                <div class="col-12">
                    <div class="form-group" style="float: right;">
                        <label class="lable">Signatur</label>
                        <div style="width: 150px; ">
      ...
      <?php } ?>
        ...
        <br>
        <center><button type="button" class="btn btn-warning" id="printbtn" onclick="window.print()">
        Print Form</button></center>
        <br>
    </div>
</div>
</body>
